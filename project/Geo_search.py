...
# Sample usage:
#   python geo_search.py --q=surfing --location"41.315797241391806,-72.91690837554932" --location-radius=5km --max-results=10
...
DEVELOPER_KEY = 'AIzaSyAJk_mbv5ChseJYlzDtrOxZgZQdbDO-mms'
